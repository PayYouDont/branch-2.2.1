...
public String toString() {
	return "WebPage [baseUrl=" + baseUrl + ", status=" + status + ", fetchTime=" + fetchTime + ", prevFetchTime="
			+ prevFetchTime + ", fetchInterval=" + fetchInterval + ", retriesSinceFetch=" + retriesSinceFetch
			+ ", modifiedTime=" + modifiedTime + ", prevModifiedTime=" + prevModifiedTime + ", protocolStatus="
			+ protocolStatus + ", content=" + content + ", contentType=" + contentType + ", prevSignature="
			+ prevSignature + ", signature=" + signature + ", title=" + title + ", text=" + text + ", parseStatus="
			+ parseStatus + ", score=" + score + ", reprUrl=" + reprUrl + ", headers=" + headers + ", outlinks="
			+ outlinks + ", inlinks=" + inlinks + ", markers=" + markers + ", metadata=" + metadata + ", batchId="
			+ batchId + "]";
}
